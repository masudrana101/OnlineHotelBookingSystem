            ...
            <div class="panel-body">
              ...
              <div class="row">
                <div class="col-lg-12 col-md-12 col-xl-12 text-right mb-3">
                  <a href="{{ route('manager.hotel.add') }}" class="brn btn-primary btn-sm">Add New</a>
                </div>
              </div>
...
{{--                      <td><img src="{{ asset($val->image) }}" width="75" height="50" alt=""></td>--}}
                      ...
                      <td>
                        <a href="{{ route('manager.hotel.details', $val->id) }}" class="btn btn-sm btn-success m-1"> <i class="fa fa-eye"></i> </a>
                        <a href="{{ route('manager.hotel.edit', $val->id) }}" class="btn btn-sm btn-success m-1"> <i class="fa fa-edit"></i> </a>
                        <span style="cursor: pointer" class="btn btn-sm btn-danger m-1 btn-delete delete_{{ $val->id }}" data-id="{{ $val->id }}"><i class="fa fa-trash-o"></i></span>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
  ...
  <script>
    $(document).ready(function () {
      ...
      $(document).on('click', '.yes-btn', function () {
        ...
        $.ajax({
          url: "{{ route('manager.hotel.delete') }}",
          method: "delete",
          dataType: "html",
          data: {id: pid},
